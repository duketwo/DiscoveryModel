...
namespace EveModel
{
    public class EveEntity : EveObject
    {
        ...
        {
           Frame.Client.movementFunctions.CallMethod("Orbit", new object[] { Id, range }, true);
        }

        public void Activate()
        { 
          Frame.Client.movementFunctions.CallMethod("ActivateAccelerationGate", new object[] { Id }, true);
        }
        ...
        {
        	Frame.Client.movementFunctions.CallMethod("WarpToItem", new object[] { this.Id, distance }, true);
        }
        ...
        public void Dock()
        {
        	Frame.Client.movementFunctions.CallMethod("DockOrJumpOrActivateGate", new object[] { Id },true);
        }
