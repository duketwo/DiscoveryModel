...
namespace EveModel
{
	public class PyCall
	{
		...
		public static extern IntPtr PyObject_Dir(IntPtr intptr_0);
		[DllImport("python27.dll")]
		...
		[DllImport("python27.dll")]
		public static extern int PyObject_HasAttrString(IntPtr intptr_0, string string_0);
		[DllImport("python27.dll")]
		public static extern int PyCallable_Check(IntPtr intptr_0);
		[DllImport("python27.dll")]
		...
		public static PyType? GetEveObjectType(IntPtr intptr, bool isDerived = false)
		{
			...
			if (isDerived)
			{
				...
				//Frame.Log("[GetEveObjectType] isDerived. str " + str + "intptr " + intptr.ToString());
				str = returnType.ToString();
				returnType = (PyType)Enum.Parse(typeof(PyType), "Derived" + str);
				} catch (Exception) {
					
					Frame.Log("[GetEveObjectType] Exception. str " + str + "intptr " + intptr.ToString());
					throw;
				}
			}
			return returnType;
